...
class UseFunctionsB extends StatefulWidget {
  @override
  UseFunctionsBState createState() => UseFunctionsBState();
}

int isSelected = 0;

class UseFunctionsBState extends State<UseFunctionsB> {
  
  
  // Create selectedNum() function Using Arrow Syntax
  void selectedNum(int index) => selected[index] ? 
    isSelected=isSelected+1 : isSelected=isSelected-1;
